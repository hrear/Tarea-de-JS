...
firebase.auth().onAuthStateChanged(user => {
    if(user){
        ...
        <button class="btn btn-outline-danger" style="margin-right:15px;" id='btnCerrarSesion'>Cerrar Sesión</button>
        `
        ...
        botones.innerHTML = /*html*/`
        <button class="btn btn-outline-success mr-2" style="margin-right:15px;" id='btnAcceder'>Acceder</button>
        `
        iniciarSesion()
